                ...
                <div class="pt-2 flex gap-2 flex-wrap justify-content-start">
                    @for (primaryColor of primaryColors(); track primaryColor.name) {
                        <button
                            ...
                            class="cursor-pointer w-5 h-5 rounded-full flex shrink-0 align-items-center justify-content-center outline-offset-1 shadow"
                            [style]="{
                ...
                <div class="pt-2 flex gap-2 flex-wrap justify-content-start">
                    @for (surface of surfaces; track surface.name) {
                        <button
                            ...
                            class="cursor-pointer w-5 h-5 rounded-full flex shrink-0 align-items-center justify-content-center p-0 outline-offset-1"
                            [ngClass]="{
